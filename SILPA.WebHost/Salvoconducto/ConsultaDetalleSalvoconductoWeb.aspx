<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaDetalleSalvoconductoWeb.aspx.cs" MasterPageFile="~/plantillas/SILPASinMenuFlashSUNL.master" Inherits="Salvoconducto_ConsultaDetalleSalvoconductoWeb" %>
    ...
    <div class="div-contenido">
        ...
        <div class="contact_form">
            <table border="1" width="90%" >
                <tr>
                    <td class="alinearTitulos" style="border:inherit" rowspan="2">EXPEDICION
                    </td>
            ...
            <table border="1" width="90%">
                <tr>
                    <td class="alinearTitulos" style="border:inherit">TIPO DE 
                        <br />
                        SALVOCONDUCTO
                    </td>
                    <td class="CentrarTexto">
                    ...
                    <td class="alinearTitulos" style="border:inherit">ESTADO SALVOCONDUCTO
                    </td>
                    <td class="CentrarTexto">
                        <asp:Label ID="LblEstadoSalvoconducto" runat="server" Text="" SkinID="etiqueta_negra"></asp:Label>
                    </td>
                    <td class="alinearTitulos" id="TituloSerieSalvoconducto" runat="server" visible="true" style="border:inherit">NUMERO SALVOCONDUCTO
                    </td>
                    ...
                    <td class="alinearTitulos" id="ColDescCodigoSeguridad" style="border:inherit" runat="server" visible="true">CODIGO SEGURIDAD
                    </td>
                    <td class="alinearSubTitulos" id="ColCodigoSeguridad" runat="server" visible="true">
                        <asp:Label ID="LblCodigoSeguridad" runat="server" Text="" ForeColor="#ff0066" Font-Bold="true" Font-Size="10pt"></asp:Label>
                    </td>
                </tr>
            </table>
            <br />
            <table border="1" width="90%" runat="server" id="TblSalvoconductosAnteriores" visible="false">
                <tr>
                    <td class="alinearTitulos" style="border:inherit">SALVOCONDUCTOS 
                        <br />
                        ANTERIORES
                    </td>
            ...
            <table border="1" width="90%">
                <tr>
                    <td rowspan="2" class="alinearTitulos" style="border:inherit">VIGENCIA DEL 
                        <br />
                        SALVOCONDUCTO 
                    </td>
            ...
            <table border="1" width="90%">
                <tr style="text-align: center">
                    <td class="alinearTitulos" rowspan="4" style="border:inherit">TITULAR DEL 
                        <br />
                        SALVOCONDUCTO 
                    </td>
            ...
            <table border="1" width="90%">
                <tr>
                    <td class="alinearTitulos" style="border:inherit">CLASE DE RECURSO
                    </td>
                    <td class="CentrarTexto">
            ...
            <br />
            <table border="1" width="90%" id="TblProcEspecimenesVarios" runat="server" visible="false">
                <tr>
                    <td class="alinearTitulos" rowspan="9" style="border:inherit">INFORMACION DE LA 
                        <br />
                        OBTENCION LEGAL 
                        <br />
                        DE LOS 
            ...
            <table border="1" width="90%" id="TblProcEspecimenesUnico" runat="server" visible="true">
                <tr>
                    <td class="alinearTitulos" rowspan="9" style="border:inherit">OBTENCION LEGAL 
                        <br />
                        DE LOS 
                        <br />
                        ESPECIMENES
            ...
            <br />
            <table border="1" width="90%" runat="server" id ="TblTransporte" visible="false"> 
                <tr>
                    <td class="alinearTitulos" rowspan="2" style="border:inherit">RUTA DE DESPLAZAMIENTO
                    </td>
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grvRutaDesplazamiento" runat="server" AutoGenerateColumns="false" ShowFooter="true" >
                                    <Columns>
            ...
            <br />
            <table border="1" width="90%" runat="server" id="TblDetTransporte" visible="false">
                <tr>
                    <td class="alinearTitulos" rowspan="2" style="border:inherit">TRANSPORTE
                    </td>
                    <td class="CentrarTexto">
            ...
            <table border="1" width="90%">
                <tr>
                    <td class="alinearTitulos" rowspan="2" style="border:inherit">INFORMACION DE ESPECIMENES
                    </td>
