<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlBasicData.ascx.cs" Inherits="LicenciasAmbientales_Controles_ctlBasicData" %>
<table style="width: 627px">
    ...
    <tr>
        <td style="height: 7px">
            <asp:RadioButtonList ID="RDG_LST_TIPO_DOCUMENTO" runat="server" RepeatDirection="Horizontal"
                Width="128px">
                <asp:ListItem Selected="True" Value="1">CC</asp:ListItem>
    ...
    <tr>
        ...
        <td colspan="1" style="width: 92px; height: 15px; text-align: right">
            <asp:Label ID="LBL_CIUDAD" runat="server" Height="20px" Text="Ciudad" Width="35px"></asp:Label></td>
