<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="FirmaNORequiereDAA.aspx.cs" Inherits="FirmaDigital_FirmaDocumento" Title="Untitled Page" %>
...
<asp:ScriptManager id="ScriptManager1" runat="server">
    ...
    <table style="width: 600px">
        ...
        <tr>
            ...
            <iframe id="ifdoc" src="../documentos/Auto_NO_Requiere_DAA.pdf" height="600" width="600" style="height: 433px" ></iframe>
            </td>
        </tr>
        <tr>
        </tr>
