<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="FirmaAutoInicio.aspx.cs" Inherits="FirmaDigital_FirmaDocumento" Title="Untitled Page" %>
...
<asp:ScriptManager id="ScriptManager1" runat="server">
    ...
    <table style="width: 600px">
        ...
        <tr>
            ...
            <iframe id="ifdoc" src="../documentos/AutoInicio.pdf" height="600" width="600" ></iframe>
            </td>
        </tr>
        <tr>
        </tr>
