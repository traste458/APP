<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="DocTipoAdquisicion.aspx.cs" Inherits="Administracion_Tablasbasicas_DocTipoAdquisicion" Title="Untitled Page" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="MODO ADQUISICION DE DOCUMENTOS" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         Width="100%" 
         AllowPaging="True" 
         AllowSorting="True" EmptyDataText="No existen datos registrados en ésta tabla" OnRowCommand="grdDatos_RowCommand" DataKeyNames="ADQ_ID" OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="ADQ_DESCRIPCION" HeaderText="Descripción" />
