<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="GenTipoPublicacion.aspx.cs" Inherits="Administracion_Tablasbasicas_GenTipoPublicacion" Title="Untitled Page" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO DE PUBLICACION" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         Width="100%" 
         AllowPaging="True" 
         AllowSorting="True" EmptyDataText="No existen datos registrados en ésta tabla" OnRowCommand="grdDatos_RowCommand" DataKeyNames="ID_TIPO_PUB" OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="NOMBRE_TIPO_PUB" HeaderText="Descripción" />
