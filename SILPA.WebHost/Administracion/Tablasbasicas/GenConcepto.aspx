<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="GenConcepto.aspx.cs" Inherits="Administracion_Tablasbasicas_GenConcepto" Title="Untitled Page" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="CONCEPTO DE PAGO" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="CON_ID, CON_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="CON_NOMBRE" HeaderText="Descripción" />
