<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="GenEstadoCobro.aspx.cs" Inherits="Administracion_Tablasbasicas_GenEstadoCobro" Title="Untitled Page" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="ESTADO DEL PAGO" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="ECO_ID,ECO_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="ECO_NOMBRE" HeaderText="Nombre" />
                <asp:BoundField DataField="ECO_DESCRIPCION" HeaderText="Descripción" />
        ...
        <tr>
            <td style="width:10%" align="left">
                <asp:Label ID="lblNombre_Nvo" runat="server" Text="Nombre"></asp:Label>
            </td>
            <td  style="width:25%" align="left">
        ...
        <tr>
            <td style="width:10%" align="left">
                <asp:Label ID="lblDescripcion_Nvo" runat="server" Text="Descripción"></asp:Label>
            </td>
            <td  style="width:25%" align="left">
