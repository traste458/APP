<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="SanTipoPersonaQueja.aspx.cs" Inherits="Administracion_Tablasbasicas_SanTipoPersonaQueja" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO USUARIO EN SANCIONATORIO" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="TPQ_ID_TIPO_PERSONA, TPQ_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="TPQ_NOMBRE" HeaderText="Descripción" />
