<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="Not_TipoDocumento.aspx.cs" Inherits="Administracion_Tablasbasicas_Not_TipoDocumento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO DE IDENTIFICACION" SkinID="titulo_principal_blanco"></asp:Label>
    </div>
...
<asp:Panel id="pnlMaestro" runat="server" Width="100%">
    ...
    <tr>
        ...
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="ID_TIPO_IDENTIFICACION" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="ID_TIPO_IDENTIFICACION" HeaderText="ID" />
                <asp:BoundField DataField="NTI_CODIGO_TIPO_ID" HeaderText="Codigo" />
                <asp:BoundField DataField="NTI_NOMBRE_TIPO_ID" HeaderText="Tipo Documento" />
            ...
            <tr>
                <td align="left" style="width: 10%">
                    <asp:Label ID="lblTipoDocumento_Nvo" runat="server" Text="Tipo Documento"></asp:Label></td>
                <td align="left" style="width: 25%">
                    <asp:TextBox ID="txtTipoDocumento_Nvo" runat="server"></asp:TextBox></td>
                <td>
                </td>
                <td>
                </td>
