<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="GenTipoDato.aspx.cs" Inherits="Administracion_Tablasbasicas_GenTipoDato" Title="Untitled Page" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO DE DATO" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="ID_TIPO_DATO,TIPO_DATO_ACTIVO_SN" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="TIPO_DATO" HeaderText="Descripción" />
