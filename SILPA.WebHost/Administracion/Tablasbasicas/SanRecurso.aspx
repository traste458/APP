<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="SanRecurso.aspx.cs" Inherits="Administracion_Tablasbasicas_SanRecurso" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="RECURSO AFECTADO" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="REC_ID_RECURSO, REC_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="REC_NOMBRE" HeaderText="Descripción" />
