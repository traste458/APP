<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true"
    CodeFile="WFActividadSilpa.aspx.cs" Inherits="Administracion_Tablasbasicas_WFActividadSilpa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="FORMULARIOS A LA MEDIDA" SkinID="titulo_principal_blanco"></asp:Label>
    </div>
...
<asp:Panel id="pnlMaestro" runat="server" Width="100%">
                                ...
                                <tr>
                                    ...
                                    <asp:GridView ID="grdDatos" runat="server"         
                                     ...
                                     DataKeyNames="ACTIVIDAD_SILPA_ID" 
                                     OnPageIndexChanging="grdDatos_PageIndexChanging">
                                        <Columns>
                                            <asp:BoundField DataField="ACTIVIDAD_SILPA_ID" HeaderText="ID Actividad" />
                                            <asp:BoundField DataField="ACTIVIDAD_SILPA_NOMBRE" HeaderText="Nombre Actividad" />
