<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="RuhTipoSancion.aspx.cs" Inherits="Administracion_Tablasbasicas_RuhTipoSancion" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO DE SANCION" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="TIS_ID_TIPO, TIS_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="TIS_NOMBRE" HeaderText="Descripción" />
