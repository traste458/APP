<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="EstadoRecurso.aspx.cs" Inherits="Administracion_Tablasbasicas_EstadoRecurso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="ESTADO DEL RECURSO DE REPOSICION" SkinID="titulo_principal_blanco"></asp:Label>
    </div>
...
<asp:Panel id="pnlMaestro" runat="server" Width="100%">
    ...
    <tr>
        ...
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="ID_ESTADO_RECURSO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="ID_ESTADO_RECURSO" HeaderText="ID Estado" />
                <asp:BoundField DataField="SER_NOMBRE" HeaderText="Nombre Estado" />
                <asp:BoundField DataField="SER_ACTIVO" HeaderText="Activo" />
