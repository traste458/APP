<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="RuhTipoFalta.aspx.cs" Inherits="Administracion_Tablasbasicas_RuhTipoFalta" %>
...
<div class = "div-titulo">
        <asp:Label ID="lblTitulo" runat="server" Text="TIPO DE FALTA" SkinID ="titulo_principal_blanco"></asp:Label>
</div>
    ...
    <tr>
     ...
     <asp:Panel ID="pnlConsultar" runat="server" Visible="true" Width="100%">
        <asp:GridView ID="grdDatos" runat="server"         
         ...
         DataKeyNames="TIF_ID_FALTA, TIF_ACTIVO" 
         OnPageIndexChanging="grdDatos_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="TIF_NOMBRE" HeaderText="Descripción" />
