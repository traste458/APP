<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPASinMenu.master" AutoEventWireup="true"
    CodeFile="parametrizarNotificacion.aspx.cs" Inherits="Administracion_Notificacion_parametrizacionNotificacion"
    Title="Untitled Page" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table width="600">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblTiempo" SkinID="etiqueta_negra" runat="server" Text="Tiempo (Hrs.):"></asp:Label>
                        </td>
                        <td style="width:300px; vertical-align:middle; height:50px">
                            ...
                            <br />
                            <asp:CheckBox ID="chkActivo" runat="server" Checked="True" SkinID="check" Text="Activo" />
