<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/plantillas/SILPA.master" CodeFile="LogAuditoria.aspx.cs" Inherits="Auditoria_LogAuditoria" Culture="Auto" UICulture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lbl_titulo_principal" runat="server" SkinID="titulo_principal_blanco" Text="Auditoria de Sistema"></asp:Label>
    </div>
    ...
    <div class="table-responsive">
        ...
        <table border="0" style="left: 0 !important; margin: 0 !important; padding: 0 !important;">
            <tr>
                ...
                <td>
                    <asp:Label ID="lblEntidad4" runat="server" SkinID="etiqueta_negra" Text="Inicial"></asp:Label>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLoginUsuario" runat="server" MaxLength="50" Width="60%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtIdentificacion" runat="server" MaxLength="20" Width="60%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtNombreUsuario" runat="server" MaxLength="50" Width="60%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="cboAutoridadAmbiental" runat="server" Width="61%">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cboModulo" runat="server" Width="61%">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cboAccionRealizada" runat="server" Width="61%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDetalleAccion" runat="server" MaxLength="4000" Width="60%"></asp:TextBox>
                </td>
            </tr>
            <tr>
