<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPASinMenu.master" AutoEventWireup="true" CodeFile="ReceptorVertimiento.aspx.cs" Inherits="ResumenEIA_InfoAdicional_ReceptorVertimiento" Title="Receptores del Vertimiento" %>
...
<asp:ScriptManager runat="server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lblTituloPrincipal" runat="server" Text="Receptor de Vertimientos" SkinID="titulo_principal_blanco"></asp:Label>
    </div>    
    <table align="center">z
    <tr>        
    <td>
