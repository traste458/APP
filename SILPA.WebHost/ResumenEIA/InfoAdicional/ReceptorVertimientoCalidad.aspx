<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPASinMenu.master" AutoEventWireup="true" CodeFile="ReceptorVertimientoCalidad.aspx.cs" Inherits="ResumenEIA_InfoAdicional_ReceptorVertimientoCalidad" Title="Untitled Page" %>
...
<asp:ScriptManager runat="server">
    ...
    <div class="div-titulo">
        <asp:Label ID="lblTituloPrincipal" runat="server" Text="Calidad Fisicoquimica" SkinID="titulo_principal_blanco"></asp:Label>
    </div>    
    <table align="center">
    <tr>        
    <td>
