<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DC_II.aspx.cs" Inherits="PermisosAmbientales_Liquidacion_DC_II"
    ...
    <div id="documento" 
        ...
        <div id="encabezado" class="dcobro" style="position: absolute; left:174px; top: 30px;
            ...
            <table>
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="lbl_nit_corporacion" runat="server" Text="NIT: 800.300.400-2" Font-Names="Tahoma"
                            Font-Size="X-Large"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style2">
                        <asp:Label ID="lbl_concepto" runat="server" Text="EL CONCEPTO DE COBRO" Font-Names="Tahoma" Font-Size="Large"></asp:Label>
                    </td>
                </tr>
            </table>
             </div>
            ...
            <table class="tableborderfull" style="height: 40px; width: 300px">
                <tr>
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="lbl_numero_referencia" runat="server" Text="25568285659" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table class="tableborderfull" style="width: 890px; height: 105px">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="right10">
                            <asp:Label runat="server" Text="$5263.32" ID="lbl_precio1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="left10">
                        ...
                        <td class="right10">
                            <asp:Label runat="server" Text="$2568.38" ID="lbl_precio2"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="left10">
                        ...
                        <td class="right10">
                            <asp:Label runat="server" Text="$10256.31" ID="lbl_precio3"></asp:Label>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="font-family: Tahoma; font-size: 12px; width: 310px;">
                <tr>
                    ...
                    <td style="text-align: right">
                        <asp:Label runat="server" Text="$18088.01" ID="lbl_subtotal"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 97px">
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-weight: bold">
                        <asp:Label runat="server" Text="$ 18088.01" ID="lbl_total"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div id="tiquete_info" style="position: absolute; left: 10px; top: 10px; bottom: 20px;
                ...
                <table id="tabla_total" class="tableborderfull" width="480px">
                    <tr>
                        ...
                        <td class="right18">
                            <asp:Label runat="server" ID="lbl_numero_referencia2" Text="25568285659" />
                        </td>
                    </tr>
                    <tr>
                        <td class="left18" style="width: 225px">
                ...
                <table id="Table1" class="tableborderfull" width="480px">
                    <tr>
                        <td class="left18Bold">
                            TOTAL A PAGAR
                        </td>
                        <td class="right18Bold">
                            <asp:Label runat="server" Text="$ 18088.01" ID="lbl_total2"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="tiquete_banco" style="border-width: thin; position: absolute; top: 1050px;
            left: 25px; width: 900px; height: 180px; border-top-style: dashed; right: 25px;">
            <span id="Span1" style="position: absolute; left: 500px; top: 70px; bottom: 38px;
                right: 10px; text-align: center; vertical-align: text-bottom;">&nbsp;<asp:Label ID="lbl_codigo_barras2"
                    runat="server" Font-Names="3 of 9 barcode" Text="CORP000000000020000000" Font-Size="30px"></asp:Label>
            </span><span id="Span2" style="position: absolute; left: 500px; top: 110px;
                bottom: 20px; right: 10px; text-align: center;">
                <asp:Label ID="lbl_numero_barras2" runat="server" Text="CORP000000000020000000"></asp:Label>
            </span>
            <div id="Div1" style="position: absolute; left: 10px; top: 10px; bottom: 20px; right: 410px;">
                <table id="Table2" class="tableborderfull" width="480px">
                    <tr>
                        <td>
                ...
                <table id="tabla_total1" class="tableborderfull" width="480px">
                    <tr>
                        ...
                        <td class="right18">
                            <asp:Label runat="server" ID="lbl_numero_referencia3" Text="25568285659" />
                        </td>
                    </tr>
                    <tr>
                        <td class="left18" style="width: 225px">
                ...
                <table id="tabla_total2" class="tableborderfull" width="480px">
                    <tr>
                        ...
                        <td class="right18Bold">
                            <asp:Label runat="server" Text="$ 18088.01" ID="lbl_total3"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
