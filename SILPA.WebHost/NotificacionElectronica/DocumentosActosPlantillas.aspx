<%@ Page Language="C#" MasterPageFile="~/plantillas/SILPASinMenuFlash.master" AutoEventWireup="true" CodeFile="DocumentosActosPlantillas.aspx.cs" Inherits="DocumentosActosPlantillas_NotificacionEstados" %>
                    ...
                    <asp:GridView runat="server" AutoGenerateColumns="False" AllowPaging="false" ID="grdDocumentos" 
                        ...
                        <Columns>
                                <asp:TemplateField HeaderText="DOCUMENTO">
                                    <ItemTemplate>
                                        <asp:literal ID="ltlDocumento" runat="server" Text='<%# Eval("TIPO_DOCUMENTO")  %>'></asp:literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="NOMBRE DOCUMENTO">
                                    <ItemTemplate>
                                        <asp:literal ID="ltlNombreDocumento" runat="server" Text='<%# Eval("NOMBRE_DOCUMENTO")  %>'></asp:literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
