<%@ Page Title="" Language="C#" MasterPageFile="~/plantillas/SILPA.master" AutoEventWireup="true" CodeFile="Modulo.aspx.cs" Inherits="Modulo" EnableEventValidation="false" %>
                ...
                <asp:Panel ID="pnl_datos_consulta" runat="server" Width="500px">
                    ...
                    <tr>
                        <td colspan="2" style="height: 21px">
                            <asp:Label ID="lbl_subtitulo" runat="server" Text="Modulo" SkinID="titulo_principal"></asp:Label>
                        </td>
